...
--- Clears a table, applying an operation to each removed item.
-- @param t Table to clear.
-- @param func Visitor function, called as<br><br>
-- &nbsp&nbsp&nbsp<i><b>func(v, arg)</b></i>,<br><br>
-- where <i>v</i> is the current value, and <i>arg</i> is the parameter.
...
function Clear (t, func, is_array, arg)
