...
local StoreTraceback = funcops.StoreTraceback
...
-- up any important state.<br><br>
-- If an error occurs in the resume or reset logic, its traceback is stored, and it is
-- propagated.
