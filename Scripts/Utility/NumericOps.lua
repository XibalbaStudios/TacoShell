...
-- index: Index to rotate
-- bottom: range's lower end
-- top: range's top end
-- to_left: If true, rotate left
-- Returns: Rotated array index
--------------------------------
function RotateIndexInRange( index, bottom, top, to_left )
	if to_left then
		return index > bottom and index - 1 or top
	else
		return index < top and index + 1 or bottom
	end
end
